...
class Project(Model):
    ...
    redmine_token = models.CharField(max_length=64) # add by hzwangzhiwei @20160922 for redmine
    redmine_host = models.CharField(max_length=64) # add by hzwangzhiwei @20160922 for redmine
